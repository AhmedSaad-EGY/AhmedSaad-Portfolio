...
export const projects: readonly Project[] = [
  clinicManagementProject,
  {
    ...
    links: [{ label: 'GitHub', href: 'https://github.com/AhmedSaad-EGY/EStateHub' }, { label: 'Live', href: 'https://e-statehub.vercel.app' }, { label: 'API', href: 'https://estatehub.runasp.net/swagger/index.html' }],
    featured: true,
