...
export const clinicManagementProject: Project = {
  ...
  cardSummary: 'Production-oriented clinic management backend covering scheduling, financial workflows, concurrency control, security, and automated testing.',
  ...
  highlights: ['Doctor, room, and medical-device scheduling conflict protection.', 'Optimistic concurrency using SQL Server rowversion.', 'Patient treatment history, prescriptions, and follow-up workflows.', 'Cashier shifts, collections, cancellation approvals, and refunds.', 'Secure authentication/authorization, CSRF protection, ProblemDetails, and health/readiness checks.', 'Domain, application, architecture, and API integration tests.'],
...
export const projects: readonly Project[] = [
  clinicManagementProject,
  {
    ...
    cardSummary: 'Multi-tenant real-estate backend with database-backed company permissions, JWT session rotation, CRM and property workflows, optimistic concurrency, and controlled file handling.',
    ...
    highlights: ['Company-level access isolation and database-backed permissions.', 'Fine-grained company RBAC and separate platform-admin authorization.', 'Persisted refresh-token sessions, token rotation/revocation, and authentication rate limiting.'],
  ...
  },
  {
    ...
    cardSummary: 'Real-time marketplace and auction backend featuring SignalR, concurrency-aware bidding, auto-bid logic, JWT authentication, refresh-token replay handling, background workers, wallet workflows, logging, and automated tests.',
    ...
    highlights: ['Real-time auctions, concurrency-aware bidding, and auto-bid.', 'Rotating refresh tokens with SHA-256 refresh-token storage.', 'Background services, wallets/subscriptions, rate limiting, and health checks.'],
  ...
  },
  {
    ...
    cardSummary: 'SQL Server service-marketplace database with relational booking, payment, and rating models, 64 stored procedures, 28 reporting views, and explicit referential-integrity constraints.',
    ...
    highlights: ['64 Stored Procedures and 28 Views.', 'Normalized relational schema with referential integrity, foreign keys, and constraints.'],
